...
//
// class KvSelectBoxDecorator {
//   KvSelectBoxDecorator({
...
//     if (!enabled) {
//       inputBorderColor = KvDesignSystem().dataInputInputColorBorderDisabled;
//     } else if (enabled && readOnly) {
//       inputBorderColor = KvDesignSystem().dataInputInputColorBorderDefault;
//     } else {
//       switch (inputState) {
...
//           inputBorderColor = KvDesignSystem().dataInputInputColorBorderError;
//           break;
